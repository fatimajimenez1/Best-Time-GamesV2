...
var videoSrc='https://www.youtube.com/embed/0Xkk1FjwXAI';
...
var videoSrc2='https://www.youtube.com/embed/RQJ2Y4hGLZs';

//Al abrir la ventana modal, le agregué autoplay igual a 1, para que se reproduzca
//automáticamente, en caso de que no se requiera la autoreproducción, se quita 
//esa parte "?autoplay=1".
$('#exampleModal2').on('show.bs.modal', function () {  
var iframe=$('#iframeVideo2');
iframe.attr("src", videoSrc2+"?autoplay=1");
});
...
var iframe=$('#iframeVideo2');
iframe.attr("src", videoSrc2);

});

var videoSrc3='https://www.youtube.com/embed/cFDJZ3d3ohM';

//Al abrir la ventana modal, le agregué autoplay igual a 1, para que se reproduzca
//automáticamente, en caso de que no se requiera la autoreproducción, se quita 
//esa parte "?autoplay=1".
$('#exampleModal3').on('show.bs.modal', function () {  
var iframe=$('#iframeVideo3');
iframe.attr("src", videoSrc3+"?autoplay=1");
});
...
var iframe=$('#iframeVideo3');
iframe.attr("src", videoSrc3);

});


var videoSrc4='https://www.youtube.com/embed/k2VFiar7ynI';

//Al abrir la ventana modal, le agregué autoplay igual a 1, para que se reproduzca
//automáticamente, en caso de que no se requiera la autoreproducción, se quita 
//esa parte "?autoplay=1".
$('#exampleModal4').on('show.bs.modal', function () {  
var iframe=$('#iframeVideo4');
iframe.attr("src", videoSrc4+"?autoplay=1");
});
